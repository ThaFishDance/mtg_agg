...
export default function ColorStats() {
  ...
  // Merge API data with display order, filling in zeros for colors with no data
      ...
      <div className="space-y-3">
        {colorRows.map(({ key, hex, name, wins, appearances, winRate }) => (
          <div key={key} className="flex items-center gap-3">
            ...
            {/* Bar */}
            <div className="flex-1 rounded-full overflow-hidden" style={{ backgroundColor: '#0d1117', height: '8px' }}>
              <div
            ...
            <div className="flex items-center gap-3 flex-shrink-0 text-right">
              ...
              <span
                ...
                style={{ color: winRate >= 50 ? '#3a9e5c' : winRate > 0 ? '#c9a84c' : '#4b5563' }}
              >
